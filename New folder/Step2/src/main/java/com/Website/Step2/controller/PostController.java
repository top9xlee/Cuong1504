...
public class PostController {
    ...
    @GetMapping("by-sub/{id}")
    public ResponseEntity<List<PostResponse>> getPostsBySub(@PathVariable Long id) {
        return status(HttpStatus.OK).body(postService.getPostsBySub(id));
    }
